...
shared result a small advertisement for Louvo, without making the share feel like an ad.**
...
- Nothing that unfurls in somebody else's group chat is a photograph of a Louvo user.
...
with the smallest amount of Louvo on it that still reads: a wordmark and the cut's name,
