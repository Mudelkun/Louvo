...
const GENERATION_COPY: Record<ReturnType<typeof generationSource>, string> = {
  server:
    'Generating a preview uploads your photo to Hairify, which passes it to the image provider and deletes it as soon as the preview is made. ' +
  ...
  direct:
    'Generating a preview sends your photo straight from this phone to the image provider; it is not stored on any Hairify server.',
        ...
        <View style={styles.about}>
          ...
          <Text style={[type.caption, { color: colors.muted }]}>
            {generationSource() === 'server'
              ? 'Previews are generated by the Hairify backend, which keeps the generator key and runs the job even if you close the app.'
