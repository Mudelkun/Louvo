  ...
  const half = (mirrored: boolean) => (
    <Svg width={size} height={size} viewBox="-36 -36 72 72">
      <G transform={mirrored ? 'scale(1,-1)' : undefined}>
        <Path d={BLADE} fill={colors.onDark} stroke="rgba(22,18,31,0.3)" strokeWidth={0.9} strokeLinejoin="round" />
...
const SCAN_GRADIENT = ['rgba(107,63,228,0)', 'rgba(107,63,228,0.24)', 'rgba(255,255,255,0.55)'] as const;
